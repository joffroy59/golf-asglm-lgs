...
set APPLICATION=Calcul La Grande Semaine - STROKEPLAY - Tn - HOMME_OU_DAME_v2.10.xlsm
set APPLICATION_1=Calcul La Grande Semaine - STROKEPLAY - T1 - HOMME_OU_DAME_v2.10.xlsm
set APPLICATION_2=Calcul La Grande Semaine - STROKEPLAY - T2 - HOMME_OU_DAME_v2.10.xlsm
set APPLICATION_3=Calcul La Grande Semaine - STROKEPLAY - T3 - HOMME_OU_DAME_v2.10.xlsm
set APPLICATION_4=Calcul La Grande Semaine - STROKEPLAY - T4 - HOMME_OU_DAME_v2.10.xlsm
set APPLICATION_5=Calcul La Grande Semaine - STROKEPLAY - T5 - HOMME_OU_DAME_v2.10.xlsm
set APPLICATION_6=Calcul La Grande Semaine - STROKEPLAY - T6 - HOMME_OU_DAME_v2.10.xlsm
set APPLICATION_FINAL=Calcul La Grande Semaine - STROKEPLAY - Finale - HOMME_OU_DAME_v2.10.xlsm
